...
// Quelle: https://stackoverflow.com/questions/4182876/how-to-write-a-string-to-a-file-in-c (Edited)
void adx_store_data(const char *filepath, const char *data, unsigned int data_lenght)
{
